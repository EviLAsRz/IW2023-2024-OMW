import{i as h,r as c,T as v,d as m,a as Y}from"./indexhtml-73f4168d.js";import{Z as G,i as M,E as w,C as g,P as _,h as p,_ as Z,$ as J,a0 as ee,a1 as te,a2 as ie,a3 as A,a4 as oe,A as re,a5 as ne,z as L,B as T,D as b,V as se,a6 as B,K as ae,X as I,a7 as E,Y as le,a8 as de,a9 as ue,aa as ce,ab as S,O as he,ac as y,ad as z,ae as D,af as $,ag as F,f as me,ah as pe,ai as _e,c as ve,aj as fe}from"./generated-flow-imports-5b2a66d1.js";import{p as be}from"./templates-830627e2.js";import{R as ge}from"./vaadin-horizontal-layout-30a33dd3.js";const x=h`
  :host {
    display: flex;
    align-items: center;
...
`,C=[G,P,ye];c("",C,{moduleId:"lumo-menu-overlay"});c("vaadin-app-layout",h`
    [part='navbar'],
    [part='drawer'] {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function R(){if(M){const s=window.innerHeight,e=window.innerWidth>s,t=document.documentElement.clientHeight;e&&t>s?document.documentElement.style.setProperty("--vaadin-viewport-offset-bottom",`${t-s}px`):document.documentElement.style.setProperty("--vaadin-viewport-offset-bottom","")}}R();window.addEventListener("resize",R);const K=document.createElement("template");K.innerHTML=`
  <style>
...
`;c("vaadin-context-menu-item",[x,N],{moduleId:"lumo-context-menu-item"});const O=h`
  :host {
    -webkit-tap-highlight-color: transparent;
...
`;c("vaadin-list-box",O,{moduleId:"lumo-list-box"});const q=h`
  :host {
...
`;c("vaadin-context-menu-list-box",[O,q],{moduleId:"lumo-context-menu-list-box"});const V=h`
  :host([phone]) {
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */c("vaadin-context-menu-overlay",[L,W],{moduleId:"vaadin-context-menu-overlay-styles"});class xe extends H(T(b(v(_)))){static get is(){return"vaadin-context-menu-overlay"}static get template(){return p`
...
`;c("vaadin-menu-bar-item",[x,N,Be],{moduleId:"lumo-menu-bar-item"});c("vaadin-menu-bar-list-box",[O,q],{moduleId:"lumo-menu-bar-list-box"});const Ie=h`
  :host(:first-of-type) {
    padding-top: var(--lumo-space-xs);
  }
`;c("vaadin-menu-bar-overlay",[C,V,Ie],{moduleId:"lumo-menu-bar-overlay"});c("vaadin-menu-bar",h`
 ...
 * Copyright (c) 2019 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Se extends j(v(b(_))){static get is(){return"vaadin-menu-bar-item"}static get template(){return p`
      <style>
        :host {
          display: inline-block;
        }
 ...
 * Copyright (c) 2019 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */c("vaadin-menu-bar-overlay",[L,W],{moduleId:"vaadin-menu-bar-overlay-styles"});class De extends H(T(b(v(_)))){static get is(){return"vaadin-menu-bar-overlay"}static get template(){return p`
      <div id="backdrop" part="backdrop" hidden$="[[!withBackdrop]]"></div>
      <div part="overlay" id="overlay" tabindex="0">
        <div part="content" id="content">
          <slot></slot>
