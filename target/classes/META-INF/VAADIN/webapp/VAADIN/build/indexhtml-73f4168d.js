...
`;ke("",it,{moduleId:"lumo-typography"});F("typography-props",Ko);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Jo=y`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */F("utility",lt);const ln=`vaadin-scroller[slot=drawer]{padding:var(--lumo-space-s)}vaadin-side-nav-item vaadin-icon{padding:0}[slot=drawer]:is(header,footer){display:flex;align-items:center;gap:var(--lumo-space-s);padding:var(--lumo-space-s) var(--lumo-space-m);min-height:var(--lumo-size-xl);box-sizing:border-box}[slot=drawer]:is(header,footer):is(:empty){display:none}html{--lumo-border-radius-s: calc(var(--lumo-size-m) / 6);--lumo-border-radius-m: calc(var(--lumo-size-m) / 2);--lumo-border-radius-l: var(--lumo-size-m)}
`,cn=r=>{const e=[];r!==document&&(e.push(X(it.cssText,"",r,!0)),e.push(X(at.cssText,"",r,!0)),e.push(X(hr.cssText,"",r,!0)),e.push(X(st.cssText,"",r,!0)),e.push(X(lt.cssText,"",r,!0)),e.push(X(ln.toString(),"",r)))},dn=cn;dn(document);export{w as A,xo as D,gn as T,Ke as _,Vo as a,So as b,B as c,Fo as d,_o as e,ur as f,nr as g,F as h,y as i,at as j,it as k,hn as l,ke as r,bo as t,co as x};
